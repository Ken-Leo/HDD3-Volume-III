...
![](images/chapter_6/854bcdefc2bd419e498abb12322f5a97b62fbf0bc6ea18f84b7b636b98903f7b.jpg)
...
![](images/chapter_6/aff1210e19fef1282312b452d58068b5863c40bcffe8785f16d5bd54b5db0ecb.jpg)
...
![](images/chapter_6/e6b831d9945652c4795a7c9b5db249b6fe8a14b8cc1495f33198ed04be8a9383.jpg)
...
![](images/chapter_6/534fd2b4d3fed0e56ddb86f981bbade62158995a8bdbe85f20b589b0622684b4.jpg)
...
![](images/chapter_6/ab58b532b75500a25c5a98ca7ec14426721561710013cbb21ae825c69fe2f19a.jpg)
...
![](images/chapter_5/f5899fc4219bdedbd6a027309ff4c86f77cbb54d244303ae42a348d6fc55d21c.jpg)
...
![](images/chapter_5/c977f7e99015465a877aaaee433ecda3224b8b222dd7243d3560b3f3b868ad4d.jpg)
...
![](images/chapter_5/dafd2a5b8603316b4d09a4303d6cf53c9cf7c2893421e19cf8704e5556a668e5.jpg)
...
![](images/chapter_5/df6254ab6b7c85e429fef987e48583a769fa9c5ae94dc3be4ee4561201ce09b3.jpg)
...
![](images/chapter_5/1424578ec734ff862831420eda0e7fff6f876625fb13191d080730cc81e2acd4.jpg)
...
![](images/chapter_5/eda3336b3e4f63e6fd3106e0525c03e8ddf4f4f700d6b067302d91fb9f1d63cc.jpg)
...
![](images/chapter_5/41cf045b5e4322ca2b7f3a40acb9d2b4af3e7226f64cd8a7a46e776f1c528b13.jpg)
...
![](images/chapter_5/27611d2ed47385d546eb3d407d7e7384bf7cbf6c6e835dd42c144b0036c021cd.jpg)
...
![](images/chapter_5/3bf4657877e69979381c09bdb5d8e28573752f250322b9be0db1ad6de9647911.jpg)
...
![](images/chapter_5/5045a94fd4428c5f10a0e578402fbf51522c1c56691f1b615f50b662a1c93b4d.jpg)
...
![](images/chapter_5/5bf35413b2860f948a1c2030af0257858450b2ebdd97d3f942cea7e5b753642d.jpg)
...
![](images/chapter_5/d575bcefb43ac4f50cd82b9e7f7123cbe4cf855029804d024ce9cd38e6b0cf7d.jpg)
...
![](images/chapter_5/f7e73d67af602208ff74bb2086707897d56802c62631271fcd0e622c9cf2b3f6.jpg)
...
![](images/chapter_5/6538b824a9002b72889ac4903f38f28f22d7bef03021af68fb4eb5a8ce304e51.jpg)
...
![](images/chapter_5/728b701ef65d4f878df65a50921fe1122f04216601d52ac332523a48d187f6cb.jpg)
...
![](images/chapter_5/10cc2cffe5209a94d2e3350d00bcc89c89cf570d32222a123ba6595ccd1578bf.jpg)
...
![](images/chapter_5/65865c16fd6ebb9661828764c61b5ff8bb965c08e44696aa571f4ad166b97878.jpg)
...
![](images/chapter_5/d6c03af45e2b9fe1b89cb0be06fe4c191efe187dfa9ba747adcefe586318d9c1.jpg)
...
เมื่อ $\hat{u}_{d}(t)$ คือค่าประมาณของสัญญาณ TA ในช่วงเวลาลตระดับ และ $\{A, B\}$ คือค่าสัมประสิทธิ์ของสมการ (5.18) ที่เป็นเลขจำนวนจริง โดยค่าสัมประสิทธิ์ A ทาใต้จาก $A = \exp(Z)$ เมื่อ
...
เมื่อ n คือจำนวนแซมเปิลของ $\{q_{k}\}$ ที่ใช้ในการประมาณค่าของสัญญาณ TA ในช่วงเวลาลตระดับ โดยที่การประมาณค่าของสัญญาณ TA ในช่วงลตระดับจะสิ้นสุดก็ต่อเมื่อ $\hat{u}_{d}(t) < 0.01$

# การแก้ไข TA

หลังจากที่ได้ต่ําประมาณของสัญญาณ TA ในแต่ละส่วนแล้ว ก็ให้นำ matterวมกันเป็นค่าประมาณของสัญญาณ TA นั่นคือ $\hat{u}(t)$ ตามสมการต่อไปนี้

$$
\hat {u} (t) = \left\{ \begin{array}{l l} \hat {u} _ {r} (t), & T _ {y} \leq t \leq \hat {T} _ {p} \\ \hat {u} _ {d} (t), & \hat {T} _ {p} \leq t \leq \hat {T} _ {f} \end{array} \right. \tag {5.21}
$$

โดยที่ $T_{y}$ คือเวลาที่ตรวจสอบสัญญาณ TA, $\hat{T}_{p}$ คือเวลาเมื่อแซมเปิล $\{q_{k}\}$ มีค่าสูงสุด, และ $\hat{T}_{f}$ คือ ต่าประมาณช่วงเวลาของสัญญาณ TA ดังนั้นสัญญาณอ่านกลับที่มีผลกระทบของ TA น้อยลงหาได้จาก

$$
z _ {k} = \left\{ \begin{array}{l l} y _ {k} - \hat {u} _ {k}, & \text { if   TA   is   present } \\ y _ {k}, & \text { if   TA   is   absent } \end{array} \right., \tag {5.22}
$$

เมื่อ $\hat{u}_{k} = \hat{u}(kT)$ คือค่าประมาณของสัญญาณ TA ลําดับที่ k จากนั้นวงจรภาครับแบบที่ใช้กัน ทั่วไปก็จะส่งลำดับข้อมูล z\_{k} ไปยังอีควอไลเซอร์แบบเทอร์โบซึ่งจะแลกเปลี่ยนข่าวสารระหว่างอีควอไลเซอร์ SOVA [19] และวงจรลอตรหัส LDPC [17] ตามจำนวนรอบที่ต้องการ

# 5.2.4 วิธีการตรวจหาและแก้ไข TA แบบวนซ้ำ

ในทางปฏิบัติวงจรภาครับแบบที่ใช้กันทั่วไปจะทำกระบวนการตรวจหาและแก้ไข TA โดยไม่ได่ใช้ประโยชน์จากรหัส ECC จึงทำให้มีสมรรถนะไม่ตี เมื่อทำงานที่ค่า SNR ต่ํา ดังนั้นเพื่อให้ระบบสามารถทำงานที่ค่า SNR ต่ําได้อย่างมีประสิทธิภาพ Kovintavewat และ Koonkarnkhai [77] จึงได้นำเสนอ “วิธีการตรวจหาและแก้ไข TA แบบวนช้ำ” เมื่อวงจรตรวจหาและแก้ไข TA, อีควอไลเซอร์แบบ SOVA, และวงจรถอตรหัส LDPC จะแลกเปลี่ยนข่าวสารร่วมกันตามที่แสดงในรูปที่ 5.17 ชื่งสามารถธิบายขั้นตอนการทำงานได้ตั้งนี้

ลําหนดให้ครั้งแรกที่วงจรอตรหัส LDPC ให้ข้อมูลเอาต์พุตในรูปช่าวสารแบบซอฟต์ $\lambda_{k}$ ออกมา เรียกว่า “การวนชํารอบที่หนึ่ง (first iteration)” ตั้งนั้นวิธีการที่นําเสนจะมีข้นตอนการทํางานในรอบแรกของการวนชําเหมือนกับวงจรภาครับที่ใช้กันทั่วไป นั่นคือสัญญาณเอาต์พุต ของจรซักตัวอย่าง $\{y_{k}\}$ จะลูกส่งเข้าไปยังวงจรตรวจหาและแก้ไข TA (ที่อธิบายในหัวข้อที่ 5.2.3) ทำให้ได้เป็นลําดับข้อมูล $\{z_{k}\}$ ชึ่งจะลูกส่งต่อไปยังอีควอไลเซอร์แบบเทอร์โบ หลังจากการวนชํารอบที่หนึ่งเสร็จ ช่าวสารแบบซอฟต์ $\{\lambda_{k}\}$ จะลูกส่งกลับไปยังวงจรตรวจหาและแก้ไข TA และอีควอไลเซอร์แบบเทอร์โบ (ดูรูปที่ 5.17) เพื่อนำไปใช้ในการหาค่าประมาณแบบซอฟต์ของลําดับข้อมูล $\{r_{k}\}$ [77] นั่นคือ $\{\tilde{r}_{k}\}$ เมื่อ (ดูภาคผนวกง)

$$
\tilde {r} _ {k} = E \left[ r _ {k} \mid \lambda_ {k} \right] = \frac {C _ {1} + C _ {2} + C _ {3}}{2 \cosh \left(\lambda_ {k} / 2\right) \cosh \left(\lambda_ {k - 1} / 2\right) \cosh \left(\lambda_ {k - 2} / 2\right)} \tag {5.23}
$$

โดยที่ $E[.]$ คือตัวดำเนินการคาดหมาย, $C_{1}=2\sinh\left(\left(\lambda_{k}+\lambda_{k-1}+\lambda_{k-2}\right)/2\right)$ , $C_{2}=\sinh\left(\left(\lambda_{k}+\lambda_{k-1}-\lambda_{k-2}\right)/2\right)$ , และ $C_{3}=\sinh\left(\left(-\lambda_{k}+\lambda_{k-1}+\lambda_{k-2}\right)/2\right)$

ในการวนชํารอบที่สองขึ้นไป วิธีการที่นำเสน Wildernessลําตับข้อมูล $\left\{\tilde{r}_{k}\right\}$ ที่ได้จากสมการ (5.23) ไปลบออกจากสัญญาณอ่านกลับ $\left\{y_{k}\right\}$ ทำให้ได้ $c_{k}=y_{k}-\tilde{r}_{k}$ นั่นคือล้า $\left\{\tilde{r}_{k}\right\}$ มีค่าเท่ากับ $\left\{r_{k}\right\}$ กี่จะทำให้ $\left\{c_{k}\right\}$ เหลือเพียงสัญญาณรบกวนและสัญญาณ TA เท่านั้น $^{29}$ จากนั้นจะส่งลําตับข้อมูล $c_{k}$ เซ่กระบวนการตรวจหาและแก้ไข TA ใหม่อีกครั้ง ซึ่งทำให้เทคนิคการประมาณค่าสัญญาณ TA ด้วยเทคนิคการปรับเส้น fix้งที่เหมาะสมแบบกำลังสองน้อยสุด [76] ในแต่ละครอบของการวนชํา ทํางานได้อย่างมีประสิทธิภาพมากขึ้น นั่นคือทำให้ลําตับข้อมูล $\left\{z_{k}\right\}$ ที่ได้มีคุณภาพดีขึ้น ซึ่งก็จะ ส่งผลให้อีควอลเซอร์แบบเทอร์โบทํางานไดดีขึ้นตามไปด้วย ดังนี้จะเห็นได้ว่าอีควอลเซอร์แบบ เทอร์โบได้ประโยชน์จากลำดับข้อมูล $\{z_{k}\}$ ที่มีคุณภาพมากขึ้น และวงจรตรวจสอบหาและแก่ไข TA ก็ได้ประโยชน์จากค่าตัดสินใจแบบซอฟต์ $\{\tilde{r}_{k}\}$ ที่มีคุณภาพมากขึ้นเช่นกัน

จากที่อธิบายในช้างต้นพบว่าวิธีการที่นำเสนอ [77] ก็ตืออีควอลเซอร์แบบเทอร์โบแบบที่ใช้กันทั่วไปเพียงแต่มีขึ้นตอนการลดผลกระทบของ TA แทรกเข้าไปในแต่ละรอบของการวนชําซึ่งผลลัพธ์ที่ได้ก็ตือ สัญญาณอ่านกลับจะมีผลกระทบของ TA ลดลง เมื่อจำนวนรอบของการวนชําเพิ่มชึ้น ในทางปฏิบติวงจรตรวจหาและแก้ไข TA มีความชับช้อนน้อยมากเมื่อเทียบกับอีควอลเซอร์แบบเทอร์โบ ดังนั้นอาจกล่าวได้ว่าวิธีการที่นำเสนอมีความชับช้อนรวมใกล้เคียงกับวงจรภาครับแบบที่ใช้กันทั่วไป จึงทำให้สามารถมาใช้งานจริงในระบบการประมวลผลสัญญาณของฮาร์ตดิสก์ไตรฟ์ได้

# 5.2.5 ผลการทดลอง

พิจารณาแบบจำลองช่องสัญญาณในรูปที่ 5.17 โดยที่ลำดับข้อมูลอินพุต $\{x_{k}\}$ จำนวน 3640 บิตลูกเข้ารหัสต้วยรหัส LDPC ปกติแบบ (3, 27) ที่มือัตรารหัสเท่ากับ 8/9 [17, 77] ทำให้เป็นลำดับข้อมูล $\{a_{k}\}$ จำนวน 4095 บิต เมื่อเมทริกซ์พาริตีเช็กในแต่ละหลักมีเลขหนึ่งจำนวน 3 ตัว และในแต่ละแกลวมีเลขหนึ่งจำนวน 27 ตัว โดยการถอตรหัส LDPC จะใช้อลกอริทีมการผ่านช่าวสาร (Message-Passing) ที่มีการวนช้ําภายในจำนวน 3 รอบ [17]

ในการจำลองระบบจะกำหนดให้นนี่ยงเช็กเตอร์มีข้อมูลจำนวน 4095 บิต และมีผลกระทบ จาก TA เกิดขึ้นที่ ณ となってหน่งบิตที่ 1000 T ของทุกเช็กเตอร์ โดยที่สัญญาณ TA มีพารามิเตอร์ μ = 2, $T_{r} = 60$ นาโนวินาที, และ $T_{d} = 0.5$ โมโครวินาที ซึ่งทำให้จำนวนแซมเปิลทั้งหมดของสัญญาณ TA เท่ากับ $T_{f} = 1030 T$ ซึ่งถือว่าเป็นกรณีที่ต้อยสุด (worst case) ในกรณีนี้ถ้าไม่มี การลดผลกระทบจาก TA ก็จะทำให้เกิดข้อผิดพลาดจำนวนมาก นอกจากนี้ในการคำนวณค่า BER จะใช้ข้อมูลจำนวน 10000 เซ็กเตอร์หรือมีข้อผิดพลาดเกิดขึ้นอย่างน้อย 1000 บิต ซึ่งจะเรียกว่า “BER given TA” และค่า SNR ที่ใช้นิยามตามสมการ (4.85) เมื่อ $E_{b} = \sum_{k} \left| h_{k} \right|^{2}$ สำหรับช่องสัญญาณ PR2 กระบวนการตรวจหา TA จะใช้ L = 51 ในการหาค่า $\{q_{k}\}$ และ $\Gamma = 2.8$ (ซึ่งถูกออกแบบจากระบบที่ไม่ถูกเข้ารหัส ณ ค่า $E_{b}/N_{0} = 10.7$ dB เพื่อทำให้เกิด BER น้อยสุดที่ต้าน ขอออกของอีควอไลเซอร์ SOVA) ในการตรวจหา TA

รูปที่ 5.19 เปรียบเทียบสมรรถนะของระบบต่างๆ ณ การวนซ้ำในรอบที่สิบ เมื่อ “No TA” คือสมรรถนะของระบบที่ไม่มี TA, “With TA” คือสมรรถนะของระบบที่ไม่มีการลดผลกระทบของ TA, “Conventional” คีอวงจรภาครับแบบที่ใช้กันทั่วไป, “Proposed” คีอวงจรภาครับที่นําเสนอตามที่อธิบายในหัวข้อที่ 5.2.4, และ “Trained” คีอวงจรภาครับที่นําเสนอซึ่งใช้ $\tilde{r}_{k}=r_{k}$ ในการลดผลกระทบของ TA จากรูปเห็นได้ซัดเจนว่าล้าระบบที่ไม่มีกระบวนการตรวจหาและแก้ไข TA จะมีสมรรถนะต้อยมาก ในขณะที่ “Proposed” มีสมรรถนะตึกว่า “Conventional” แต่มีสมรรถนะ ต้อยกว่า “Trained” และ “No TA” เพียง 0.6 dB และ 0.8 dB ตามลำดับ ณ ระดับ BER = 10 $^{-4}$ นอกจากนี้รูปที่ 5.20 เปรียบเทียบสมรรถนะของ “Proposed” และ “Conventional” ในรูปของอัตราข้อผิดพลาดของเชกเตอร์ (SER: sector-error rate) เทียบกับจำนวนรอบของการวนช้ำ ชื่งจะพบว่าเมื่ออีดาวไลเซชั้นแบบเทอร์โบสามารถช่วยเพิ่มสมรรถนะของวงจรภาครับแบบที่ใช้กันเทั่วไปได้จนถึงรอบที่หกของการวนช้ำ จากนี้นระบบจะเผชิญกับปัญหาเรื่องพื้นข้อผิดพลาด (error floor)
...
รูปที่ 5.19 สมรรถนะของระบบต่างๆ ณ การวนช้ำในรอบที่สิบ
...
รูปที่ 5.20 อัตราข้อผิดพลาดของเชกเตอร์ (SER) เที่ยบกับจำนวนรอบของการวนช้ำ
...
รูปที่ 5.21 ค่า MSE ที่เกิดจากวงจรภาครับที่นำเสนอ ณ ค่า $E_{b}/N_{0}$ ต่างๆ

ในทางตรงกันข้ามวงจรภาครับที่นำเสนอหรือ “Proposed” ยังคงให้สมรรถนะที่ดีขึ้นเรื่อยๆ ตามจำนวนรอบของการวนช้าที่เพิ่มขึ้น ซึ่งหมายความว่าค่าประมาณของสัญญาณ TA หรือ $\hat{u}(t)$ ที่ได้จากเทคนิคการปรับเส้นได้นที่เหมาะสมแบบกำลังสองน้อยสุด [76] มีคุณภาพดีขึ้น ซึ่งส่งผลให้ค่าตัดสินใจแบบซอฟต์ $\{\tilde{r}_{k}\}$ มีคุณภาพดีขึ้นเรื่อยๆ ในแต่ละครอบของการวนช้า ผลสรุปนี้สามารถยืนยันได้จากการวาดกราฟแสดงข้อผิดพลาดกำลังสองเฉลี่ย (MSE: mean-squared error) ระหว่างสัญญาณ TA จริง $u(t)$ และ $\hat{u}(t)$ ตามรูปที่ 5.21 โดยที่

$$
\mathrm{MSE} = 1 0 \log_ {1 0} \left(\frac {1}{T _ {f}} \sum_ {k = T _ {y}} ^ {T _ {y} + T _ {f}} \left\{u (k T) - \hat {u} (k T) \right\} ^ {2}\right) \tag {5.24}
$$

มีหน่วยเป็น dB และ $T_{y}$ คือเวลาที่ตรวจพบลัญญาณ TA จากรูปเห็นได้ชัดเจนว่าความไม่สอดคล้องระหว่าง $u(t)$ และ $\hat{u}(t)$ ลดลงเมื่อจำนวนรอบของการวนซ้ำเพิ่มซื้น ดังนั้นจึงเป็นเหตุผลว่าingly “Proposed” จึงมีสมรรถนะตึกว่า “Conventional” โดยเฉพาะอย่างยิ่งเมื่อจำนวนรอบของการวนซ้ำมีค่ามาก

นอกจากนี้รูปที่ 5.22 เปรียบเทียบสมรรถนะของระบบต่างๆ ที่เป็นฟังก์ชันของตัวประกอบ
ค่าสูงสุด ณ การวนชําในรอบที่สืบและ $E_{b}/N_{0}=6.65$ dB เมื่อสมรรถนะของระบบที่ไม่มี TA หรือ
“No TA” มีค่า BER = $10^{-5}$ ในทำงานเดียวกันระบบจะมีสมรรถนะต้อยมาก ถ้าระบบไม่มีกระบวนการ
การตรวจสอบหาและแก้ไข TA นอกจากนี้สมรรถนะของระบบแบบที่ใช้กันท่ว่ไปในรอบที่หนึ่งมีค่าคงที่ ชีงสอดคล้องกับข้อสรุปของระบบที่ใช้เทคนิคการปรับเส้นได้งที่เหมาะสมแบบกำลังสองน้อยสุดที่ว่า ระบบจะมีความทนทานต่อการเปลี่ยนแปลงค่าแอมพลิจุดสูงสุดของสัญญาณ TA [76] จากรูปจะ เห็นได้ว่าระบบต่างๆ มีค่า BER ต่อนข้างสูง ทั้งนี้เป็นเพราะว่าสัญญาณ TA ที่ใส่เข้าไปในระบบ ถือว่าเป็นสัญญาณ TA ที่ต่อนข้างรุ่นแรง กล่าวคือข้อมูลแต่ละเชกเตอร์มี TA เกิดขึ้นหนึ่งครั้ง ชิ่งมีแอมพลิจุดสูงและมีช่วงเวลาลระดับที่ยาวนาน อย่างไรก็ตาม “Proposed” ยังคงให้สมรรถนะ ที่ตึกว่า “Conventional” สำหรับทุกค่าแอมพลิจุดสูงสุดของสัญญาณ TA
...
รูปที่ 5.22 สมรรถนะของระบบในรูป BER สำหรับระดับความรุนแรงของสัญญาณ TA ต่างๆ

# 5.2.6 สรุปผลการทดลอง

ความชุรุชระเชิงความร้อนหรือ TA ที่เกิดขึ้นในฮาร์ตติสก์ไตรฟ์จะส่งผลให้สมรรถนะรวมของระบบต้อยลงผาก ในที่นี้ได้อธิบายเทคนิคการปรับเส้น procังที่เหมาะสมแบบกำลังสองน้อยสุด [76] เพื่อใช้ลดผลกระทบของ TA ที่พบในสัญญาณอ่านกลับ โดยวิธีการตรวจหาการเกิด TA จะอยู่บนพื้นฐานของการหาชีดเริ่มเปลี่ยน และวิธีการแก้ไขผลกระทบที่เกิดจาก TA ทำได้โดยการหาค่าเฉลี่ยของสัญญาณอ่านกลับ แล้วใช้เทคนิคการปรับเส้น procังที่เหมาะสมแบบเชิงเส้นและแบบเลขชี้กำลังเพื่อหาค่าประมาณของสัญญาณ TA จากนั้นจึงนําค่าประมาณของสัญญาณ TA ที่ได้มาลบออกจากสัญญาณอ่านกลับ ก็จะได้สัญญาณอ่านกลับที่มีผลกระทบของ TA น้อยลง

ในทางปฏิบัติวงจรภาครับแบบที่ใช้กันทั่วไป (ซึ่งทำกระบวนการตรวจหาและแก้ไข TA และอีควอลเซชันแบบเทอร์โบแยกจากกันโดยอิสระ) จะไม่สามารถทำงานได้ดี เมื่อ SNR มีค่าน้อย
# 5.2.4 Iterative TA detection (continued from batch 2)
ตั้งนั้นในหัวช้อนี้ได้อธิบายวิธีการลดผลกระทบของ TA แบบวนช้า [77] ซึ่งเป็นการทำงานร่วมกันระหว่างกระบวนการตรวจหาและแก้ไข TA และอีตวอลไลเซชันแบบเทอร์โบ โดยในแต่ละครอบของการวนช้า วิธีการลดผลกระทบของ TA แบบวนช้าจะใช้ค่าตัดสินใจแบบซอฟต์ที่ได้จากวงจรลอตรหัส LDPC มาช่วยเพิ่มสมรรถนะการทำงานของอัลกอริที่มตรวจหาและแก้ไข TA [76] เพื่อให้ได้สัญญาณอ่านกลับที่มีคุณภาพตี่ชั้น ซึ่งก๊ะส่งผลกระทบให้อีควอลไลเซอร์แบบเทอร์โบสามารถทำงานได้อย่างมีประสิทธิภาพมากขึ้นในรอบถัดไป ผลการทดลองแสดงให้เห็นว่าวิธีการลดผลกระทบของ TA แบบวนช้ามีสมรรถนะตึกว่างจรภาครับแบบที่ใช้กันทั่วไป โดยเฉพาะอย่างยิ่งเมื่อจำนวนรอบของการวนช้าเพิ่มขึ้น นอกจากนี้วิธีการลดผลกระทบของ TA แบบวนช้านี้ถือว่ามีความชับช้อนใกล้เคียงกับวงจรภาครับแบบที่ใช้กันทั่วไป จึงทำให้สามารถนำมาใช้งานจริงในระบบการประมวลผลสัญญาณของฮาร์ดติสก์ใครฟ์ได้

# 5.3 สรุปท้ายบท

ในบทนี้ได้อธิบายวิธีการนำเทคนิคการลอตรหัสแบบวนช้ามาประยุกต์ใช้ว่าวมกับไหมมิ่งริตัฟเวอรี่โยอาศัยเทคนิค PSP ทำให้ได้เป็นวงจรภาครับรูปแบบใหม่ที่เรียกว่าไหมมิ่งริตัฟเวอรี่แบบ PS-ITR ซึ่งจะแลกเปลี่ยนช่าวสารแบบซอฟต์ระหว่าง PSP-BCJR และวงรถอตรหัส ECC โดยจากการทดลองพบว่าเมื่อระบบมีความรุนแรงของไหมมิ่งจิตเตอร์มาก ไหมมิ่งริตัฟเวอรี่แบบ PS-ITR จะมีสมรรถนะตึกว่างจรภาครับแบบที่ใช้กันทั่วไปและวิธีการ NBM มาก (แต่ก็มีความซับซ้อนสูง)อย่างไรก็ตามในบทนี้ยังแสดงให้เห็นว่าเมื่อความซับซ้อนของระบบลูกจากกัดให้อยู่ในระดับน้อยถึงปานกลาง ไหมมิ่งริตัฟเวอรี่แบบ PS-ITR กัยยังคงมีสมรรถนะตึกว่าไหมมิ่งริตัฟเวอรี่แบบที่ใช้กันทั่วไปและวิธีการ NBM จึงทำให้สามารถนำมาใช้งานจริงในระบบการประมวลผลลัญญาณของฮาร์ตดิสก์ใครฟ์ได้

นอกจากนี้ยังได้อธิบายวิธีการนำเทคนิคการลอตรหัสแบบวนช้ามาใช้แก่ปัญหาเรื่องความ
ชรุชระเชิงความร้อน (TA) ทำให้ได้เป็นวิธีการลดผลกระทบของ TA แบบวนช้า ซึ่งเป็นการทำงาน
ร่วมกันระหว่างกระบวนการตรวจหาและแก้ไข TA และอีควอไลเชชั้นแบบเทอร์โบ โดยจากผลการ
ทดลองพบว่าวิธีการลดผลกระทบของ TA แบบวนช้ามีสมรรถนะตึกว่างจรภาครับแบบที่ใช้กัน
ทั่วไป (ที่ทำกระบวนการตรวจหาและแก้ไข TA และอีควอไลเชชั้นแบบเทอร์โบเป็นอิสระต่อกัน)
โดยเฉพาะอย่างยิ่งเมื่อจำนวนรอบของการวนช้าเพ่มขึ้น นอกจากนี้วิธีการลดผลกระทบของ TA
แบบวนช้านี้ยังมีความชับช้อนใกล้เคียงกับวงจรภาครับแบบที่ใช้กันทั่วไป จึงทำให้สามารถนำมาใช้
งานจริงในระบบการประมวลผลสัญญาณของฮาร์ตดิสก์ไตรฟ์ได้เช่นกัน

# 5.4 แบบฝึกหัดท้ายบท

1. จงอธิบายหลักการทำงานของไหมมิ่งริคั้งเวอรี่แบบ PS-TR และ PS-ITR   
2. จากแบบจำลองช่องสัญญาณ PR4 ในรู้ปที่ 5.1 เมื่อ $H(D) = 1 - D^{2}$ จะพิสูจน์ว่าไหมมิ่งริกค์ฟเวอรีแบบ PS-TR จะใช้ค่า $K_{T} = 3 T/16$ ในสมการ (5.4)   
3. จากแบบจำลองช่องสัญญาณ PR2 ในรูปที่ 5.1 เมื่อ $H(D) = 1 + 2D + D^{2}$ จงหาค่า $K_{T}$ ที่ต้องใช้ในไหมมิ่งริดีฟเวอรีแบบ PS-TR ตามสมการ (5.4)   
4. จงพิสูจน์ค่าประมาณแบบซอฟต์ $\tilde{r}_{k}$ ในสมการ (5.10)   
5. จากแบบจำลองช่องสัญญาณ PR2 ในรูปที่ 5.1 เมื่อ $H(D) = 1 + 2D + D^{2}$ จงหาค่าประมาณ
แบบซอฟต์ $\tilde{r}_{k} = E\left[r_{k} \mid y_{k}\right]$ ของช่องสัญญาณ PR2   
6. จงอธิบายหลักการทำงานของ PSP-BCJR และ PSP-SOVA   
7. จงอธิบายหลักการทำงานของวิธีการลดผลกระทบของ TA แบบวนซ้ำ   
8. จากแบบจำลองช่องสัญญาณ PR4 ในรูปที่ 5.7 เมื่อ $H(D) = 1 - D^{2}$ จงหาค่าประมาณแบบ ชอฟต์ $\tilde{r}_{k} = E[r_{k} \mid \lambda_{k}]$ ช่องสัญญาณ PR4

# บทที่ 6

# เทคโนโลยี BPMR

ปัจจุบันนี้การเติบโตทางด้านอินเทอร์เน็ตและการสื่อสารดิจิทัลเป็นไปอย่างรวดเร็วจึงส่งผลทำให้มีความต้องการของพื้นที่ในการจัดเก็บข้อมูลเพิ่มมากขึ้นเรื่อยๆ ฮาร์ตดิสก์ไตรฟ์ในปัจจุบันจะใช้สื่อบันทึกที่เคลื่อบต้ายฟิล์มบางของสารแม่เหล็กซึ่งประกอบด้วยเกรนเชิงแม่เหล็ก $^{30}$ (magnetic grain) ขนาดเล็กในระดับนาโนเมตร โดยแต่ละเกรนจะมีสภาพความเป็นแม่เหล็ก (magnetization) ไปในทิศทางที่แตกต่างกัน ดังนี้นการบันทึกข้อมูลจะอาศัยสนามแม่เหล็กจากหัวเขียน (write head) เพื่อทำให้เกรนหลายๆ เกรนมีสภาพความเป็นแม่เหล็กไปในทิศทางที่ต้องการ (ขนาดนหรือตั้งฉากกับระนาบของสื่อบันทึก) โดยทั่วไปการเพิ่มความหนาแน่นเชิงพื้นที่ (areal density) หรือความจุข้อมูลทำให้โดยการลดขนาดของเกรนให้เล็กลง อย่างไรก็ตามการลดขนาดของเกรนเพื่อเพิ่มความหนาแน่นเชิงพื้นที่มีแนวนโน้มที่จะทำให้ยากขึ้น เพาะเกรนที่มีขนาดเล็กมากเกินไปจะไม่มีเสถียรภาพในการเก็บข้อมูล เนื่องจากพลังงานความร้อนจากภายนอกจะทำให้สภาพความเป็นแม่เหล็กของเกรนมีทิศทางเปลี่ยนไปได้ง่าย (ทำให้บิตข้อมูล “0”เปลี่ยนเป็น “1” หรือในทางตรงกันซ้าม) ซึ่งปรากฏการณ์นี้เรียกว่า “ชีดจำกัดซูเปอร์พาราแมกเนติก $^{31}$ (super-paramagnetic limit)” [1, 43] หรือชีดจำกัดความหนาแน่นเชิงพื้นที่

ตั้งนั้นเทคโนโลยีใหม่ที่สามารถจัดเก็บข้อมูลได้มากกว่าเทคโนโลยีการบันทึกข้อมูลแบบที่ใช้ในปัจจุบัน (นั้นคือแบบแนวตั้ง) จึงเป็นสิ่งจำเป็นอย่างยิ่งในอนาคต เช่น เทคโนโลยี HAMR (heat assisted magnetic recording) [78], เทคโนโลยี BPMR (bit-patterned magnetic recording) [79], และเทคโนโลยี TDMR (two-dimensional magnetic recording) [80] เป็นต้น ซึ่งเทคโนโลยีเหล่านี้สามารถจัดเก็บข้อมูลได้มากกว่า 1 เทระบิตต่อตารางนี้ว (terabits/in² หรือ Tb/in²)

![](images/74e03cc7db74b65e1db545a3209a5ad294371640fd3c90fa264c2781b2bd2e65.jpg)
...
ในบทนี้จะอธิบายเฉพาะพื้นฐานและหลักการทำงานของเทคโนโลยี BPMR พร้อมทั้งสรุปภาพรวมของงานวิจัยต่างๆ ที่ผ่านมาที่เกี่ยวข้องกับเทคโนโลยี BPMR เพื่อให้ผู้อ่านสามารถใช้เป็นจุดเริ่มต้นในการท่าวิจัยทางด้านระบบการประมวลผลสัญญาณของเทคโนโลยี BPMR ได้

# 6.1 บทนำ

ในระบบการบันทึกเชิงแม่เหล็ก สมรรถนะของระบบในรูปของอัตราข้อผิดพลาดของบิต (BER: bit-error rate) จะชื่นอยู่กับค่าอัตราส่วนกำลังของสัญญาณต่อกําลังของสัญญาณรบกวน (SNR: signal-to-noise ratio) ชื่งในทางปฏิบัติค่า SNR ในสัญญาณอ่านกลับจะสัมพันธ์กับจำนวนเกรนต่อบิตเซลล์ (bit cell) หรือข้อมูลหนึ่งบิต โดยทั่วไปสัญญาณรบกวนการเปลี่ยนสถานะ (transition noise) ถือว่าเป็นสัญญาณรบกวนหลักที่พบมากในระบบการบันทึกแบบแนวตั้ง [79] ชื่งความรุนแรงของสัญญาณรบกวนการเปลี่ยนสถานะนี้ชื่นอยู่กับการเปลี่ยนแปลงแบบซิกแขก (zig-zag transition) ณ บริเวณรอยต่อที่เป็นชอบเขตของแต่ละบิตเซลล์ โดยการเปลี่ยนแปลงแบบซิกแขกจะมีความรุนแรงเมื่อเกรนแต่ละเกรนมีขนาดใหญ่ (และรุนแรงน้อยเมื่อเกรนมีขนาดเล็ก) ตั้งแสดงในรูปที่ 6.1 ดังนี้นถ้าสื่อบันทึกที่ใช้ประกอบด้วยเกรนขนาดใหญ่จำนวนมาก ก็จะส่งผลทําให้ระบบต้องเผซิญกับปัญหาเรื่องสัญญาณรบกวนการเปลี่ยนสถานะที่รุนแรง เพาะฉะนั้นสื่อบันทึกที่สร้างจากเกรนขนาดเล็กจึงเป็นสิ่งที่จำเป็นอย่างยิ่ง และหนึ่งบิตเซลล์ก็ควรประกอบด้วยเกรนขนาดเล็กจำนวนมาก เพียงพอเพื่อให้ระบบมีค่า SNR ตามที่ต้องการ

โดยทั่วไปการเพิ่มความจุข้อมูลของฮาร์ตติสก์ไตรฟ์ทำให้โดยการลดขนาดของบิตข้อมูลให้เล็กลง แต่ยังคงรักษาระดับ SNR ให้เท่าเติม หรือกล่าวอีกนัยหนึ่งคือการลดขนาดของเกรนให้เล็กลง แต่ยังคงมีจำนวนเกรนต่อหนึ่งบิตเชลล์คงเติม อย่างไรก็ตามขนาดของเกรนไม่ควรเล็กเกินไปเพราะพลังงานความร้อนจากภายนอกจะสามารถเปลี่ยนทิศทางสภาพความเป็นแม่เหล็กของเกรนได้ (ทำให้ไม่มีเสถียรภาพในการจัดเก็บข้อมูล) นั่นคือทำให้เกิดปัญหาเรื่องซูเปอร์พาราแมกเนติก [1, 43] ซึ่งเป็นชีดจากัดที่ทำให้เทคโนโลยีการบันทึกเชิงแม่เหล็กที่ใช้ในปัจจุบันไม่สามารถเพิ่มความหนาแน่นเชิงพื้นที่ได้มากกว่า 1 Tb/in² ในทางปฏิบัติปัญหาเรื่องชูเปอร์พาราแมกเนติกสามารถป้องกันได้โดยการใช้สื่อบันทึกที่มีค่าอัตราส่วน [1, 43]

$$
\frac {K _ {u} V}{k _ {B} T} \geq \beta \tag {6.1}
$$

เมื่อ $K_{u}$ คือค่าสัมประสิทธิ์แอนไอโซтроปีแบบแกนเตี่ยวของวัสดุ, V คือปริมาตรของเกรนที่ใช้เก็บข้อมูลหนึ่งบิต, $k_{B}$ คือค่าคงตัวโบลดซ์แผน (Boltzmann's constant) มีค่าเท่ากับ $1.38 \times 10^{-23}$ จุลต่อเคลวิน (joules per kelvin), T คืออุณหภูมิสัมบูรณ์มีหน่วยเป็นเคลวิน, และ β คือจำนวนเต็มบวกที่มีค่ามากๆ เช่น β=60 เป็นต้น เนื่องจากค่า $k_{B}T$ เป็นค่าคงตัว ดังนั้นเพื่อชดเชยปริมาตรของเกรนที่ลดลง สื่อบันทึกจะต้องใช้สารแม่เหล็กที่มีค่า $K_{u}$ สูงมากขึ้น ซึ่งผลที่ตามมากก็คือหัวเขียนจะต้องใช้สนามแม่เหล็กที่มีความเข้มสูงมากในการเขียนบัตข้อมูลลงไปจัดเก็บในสื่อบันทึกได้อย่างมีเสถียรภาพ ปัญหานี้แก่ใช้ได้โดยใช้เทคโนโลยี HAMR [78] (ดูรายละเอียดในบทที่ 8) แต่อย่างไรกีตามสื่อบันทึกที่ใช้ในปัจจุบัน (ที่เคลือบด้วยฟิล์มบางของสารแม่เหล็ก) ก็กล้างจะถึงชีตจำกัดของการจัดเก็บข้อมูลในอนาคตตอนไกลนี้

เทคโนโลยี BPMR ถือว่าเป็นเทคโนโลยีที่สามารถเพิ่มความหนาแน่นเชิงพื้นที่ได้มากกว่า 1 Tb/in² และไม่มีปัญหาเรื่องชัดจำกัดซูเปอร์พาราแมนติก [79] โดยเทคโนโลยี BPMR จะใช้สื่อบันทึกที่มีการทำแบบ (patterned media) หรือสื่อบันทึกที่มีรูปแบบแน่นอน ซึ่งสร้างจากสาร แม่เหล็กที่มีโตเมนแม่เหล็กเดี่ยว (single magnetic domain) หรือมีลักษณะเป็นไอแลนต์เชิง แม่เหล็ก (magnetic island) ขนาดนาโนเมตร เรียงตัวกันบนแผ่นรองรับที่才能够จากวัสดุที่ไม่เป็น แม่เหล็ก (non-magnetic material) อย่างเป็นระเบียบและมีระยะห่างสม่ำเสมอ โดยทิศทางของ สภาพความเป็นแม่เหล็กของไอแลนต์อาจจะขนาดนหรือตั้งฉากกับแผ่นรองรับก็ได้ รูปที่ 6.2 แสดง ตัวอย่างการจัดเก็บข้อมูลในสื่อบันทึกของเทคโนโลยี BPMR

เนื่องจากไอแลนด์เชิงแม่เหล็กขนาดนาโนแบบเอกเทศ (isolated nano-scale magnetic islands) ที่ถูกล้อมรอบด้วยวัสดุที่ไม่เป็นแม่เหล็กจะ那一หน้าที่เป็นแบบ “โตเมนเดี่ยว (single domain)” หรือ那一หน้าที่เสมอเป็นไอแลนด์แบบเกรนเดี่ยว $^{32}$ ดังนั้นการใช้เกรนขนาดเล็กจำนวนมากต่อหนึ่ง บิตข้อมูลจึงเป็นสิ่งที่ไม่จำเป็นสำหรับเทคโนโลยี BPMR นั่นคือไอแลนด์หนึ่งไอแลนด์อาจสร้างจากเกรนเพียงเกรนเดี่ยวก็ได้ นอกจากนี้การใช้ไอแลนด์เชิงแม่เหล็กแบบโตเมนเดี่ยวยังสามารถจัดการ กับปัญหาเรื่องชีตจากัตซูเปอร์พาราแมกเนติก และช่วยลดปัญหาเรื่องสัญญาณรบกวนการเปลี่ยน สถานะได้อีกต้วย [81]

![](images/7a36ae130aac0e360aab47949df8a40cd75dc17b46a78dbc7ec102279b82cffe.jpg)
...
![](images/dc7761de7bded6eb47001a1e7f4837e7703dfae5b35424286f2f54139e4e6dd3.jpg)
...
ในเทคโนโลยี BPMR た่าแหน่งของไอแลนด์ทั้งหมดจะลูกกำหนดไวเรียบร้อยแล้วตั้งแต่ขั้นตอนการทำแบบ (หรือการสร้าง) ของสื่อบันทึก จึงทำให้มีข้อตีจำนวนมากเมื่อนำมาใช้งานจริง เช่น ลดปัญหาเรื่องสัญญาณรบกวนการเปลี่ยนสถานะ, กำหนดปัญหาเรื่องการเลื่อนบิตแบบไม่เป็นเชิงเส้น (nonlinear bit shift), ทำให้กระบวนการภูข้อมูลง่ายชิ้น, และทำให้กระบวนการติดตาม (tracking) ที่ใช้ในระบบเซอร์โอ (servo system) ง่ายชิ้น [81, 82] เป็นต้น

# 6.2 วิวัฒนาการของเทคโนโลยี BPMR

หัวข้อนี้จะกล่าวถึงวิวัฒนาการของเทคโนโลยี BPMR ตั้งแต่เริ่มแรกจนถึงปัจจุบัน เพื่อให้ผู้อ่าน ทราบถึงงานวิจัยต้านต่างๆ ที่น่าสนใจที่มีส่วนช่วยทำให้เทคโนโลยี BPMR สามารถนำมาใช้งานจริง ในอนาคตต้อนไกลนี้ได้

# 6.2.1 สื่อบันทึก

ในช่วงแรงงานวิจัยทางต้านเทคโนโลยี BPMR จะเน้นไปที่การพัฒนาหรือการสร้างสื่อบันทึกที่มีการทำแบบ แนวคิดในการทำแบบของสื่อบันทึกเริ่มมาตั้งแต่ปี ค.ศ. 1963 [83] โดยมีการเสนอให้