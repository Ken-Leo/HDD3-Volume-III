...
และของระบบการบันทึกแบบแนวตั้งมีค่าเท่ากับ

$$
M \left( \Omega \right) = \exp \left\{ - \pi \left| \Omega \right| \mathrm { N D } \right\} \left( 1 + \exp \left\{ - j 2 \pi \Omega \right\} \right)
$$

เมื่อ $\exp \{ . \}$ คือฟังก์ชันเลขชี้กำลัง, $\Omega = f T$ คือความถี่แบบนอร์มอลไลซ์ (normalized frequency), $f$ คือความถี่มีหน่วยเป็นเฮิรตซ์, $|x|$ คือค่าสัมบูรณ์ของ $x$, และ $j = \sqrt { - 1 }$

4. จากผลการแปลงฟูเรียร์ของผลตอบสนองไดบิตในข้อ 3 จงวาดรูปผลตอบสนองเชิงความถี่ของ ช่องสัญญาณ ณ ค่า ND ต่างๆ ในรูปที่ 1.5 โดยใช้โปรแกรม SCILAB
...
8. จงอธิบายความหมายของอัตราส่วนควรจะเป็นแบบลอการิทึม (LLR: log-likelihood ratio)

9. จงอธิบายความหมายของค่า LLR แบบอะพิรืออริ และค่า LLR แบบอะโพสเทอริออริ

10. จงอธิบายความหมายของวงจรตรวจหาแบบ SISO และวงจรถอดรหัสแบบ SISO
